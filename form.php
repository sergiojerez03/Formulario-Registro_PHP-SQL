...
<body>
    ...
    <div class="container">
        <div class="header">
            <div class="boton">
                <a class="boton-atras" href="javascript:history.back()">Atrás</a>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="tipo_documento" name="tipo_documento" required>
                        <option value="Selecciona tu Documento">Selecciona tu Documento</option>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="municipio" name="municipio" required>
                        <option value="Eliga tu Municipio">Eliga tu Municipio</option>
    ...
    <script>
        // Script del token de SergioJerez
        window.onload = function() {
            var urlParams = new URLSearchParams(window.location.search);
            if (urlParams.has('id')) {
                alert('SergioJerez' + urlParams.get('id').padStart(6, '0'));
            }
        }
    </script>
</body>
